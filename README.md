# 🤖 Guid for launching [B-User](https://t.me/b_usersbot/join?startapp=ref-xAF7MD7TLUUo6sAwysTboE) bot

![img1](./images/b-user.png)
...
| Auto joining camps                                       | <div align="center"> ☑️ </div> |
| Add 💎 smile in your nickname                            | <div align="center"> ☑️ </div> |
...
| **REF_ID**                  | <small>Your referral link in the format `'ref-xAF7MD7TLUUo6sAwysTboE'`</small>                      |
...
## Step 1: Preparation
   ...
   * Download and extract the archive or use the command
     ...
     ```
     git clone https://github.com/duonanotte/B-User.git
     ```
